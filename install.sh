...
DEMO_NAME="contrail-oauth-client-cred-flow-demo"
DEMO_LINK="http://bamboo.ow2.org/artifact/CONTRAIL-TRUNK/JOB1/build-latestSuccessful/Packages/common/oauth/oauth-java-client-demo/client-cred-flow/target/${DEMO_NAME}.tar.gz"
